...
urlpatterns = [
    ...
    path('account/<pk>/settlement_credit/', views.account_settlement_credit_add_view, name='account_settlement_credit_add_view'),
    path('account/<pk>/settlement_debit/', views.account_settlement_debit_add_view, name='account_settlement_debit_add_view'),
